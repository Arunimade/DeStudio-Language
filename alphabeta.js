// Full Assamese Alphabets with Pronunciations
const assameseAlphabets = [
    // Vowels (Swarabarna)
...
function updateAlphabet() {
    const alphabet = assameseAlphabets[currentIndex];
...
function nextAlphabet() {
    if (currentIndex < assameseAlphabets.length - 1) {
        currentIndex++;
        updateAlphabet();
    }
}
