const rajasthaniAlphabets = [
    ...
    { symbol: "क्ष", pronunciation: "Ksha (क्ष)" },
    { symbol: "ज्ञ", pronunciation: "Gya (ज्ञ)" }
];
...
function updateAlphabet() {
    const alphabet = rajasthaniAlphabets[currentIndex];
...
function nextAlphabet() {
    if (currentIndex < rajasthaniAlphabets.length - 1) {
        currentIndex++;
        updateAlphabet();
    }
}
